<div class="sm:w-82.5 min-h-70 p-6 rounded-2xl border-gray-100 border-2 justify-between flex flex-col bg-white">
    ...
    <div>
        @php
            $restante = $call->created_at
                ->addMinutes($call->priority->expected_time_minutes)
